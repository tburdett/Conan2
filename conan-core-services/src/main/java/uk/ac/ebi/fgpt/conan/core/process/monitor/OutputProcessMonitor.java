 ...
 * Time: 17:38
 */
public class OutputProcessMonitor implements Runnable {

    private static Logger log = LoggerFactory.getLogger(OutputProcessMonitor.class);
    ...
    public OutputProcessMonitor(ProcessAdapter processAdapter, int interval) {
