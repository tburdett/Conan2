...
function authenticate(options) {
    ...
    var restApiKey = getCookie("conanRestApiKey");
...
function loginUser(userJson, restApiKey, callback) {
    ...
    setCookie("conanRestApiKey", restApiKey, expires);

    // also, if the user has admin privileges, show admin link
    if (userJson.permissions == "ADMINISTRATOR") {
        $("#conan-admin-link").css({"display": "inherit"});
    }
