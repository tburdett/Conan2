    ...
    j.fn.dataTable = function (g) {
        function l() {
            ...
            this.fnDisplayEnd = function () {
                return this.oFeatures.bServerSide ? this.oFeatures.bPaginate === false || this._iDisplayLength == -1 ? this._iDisplayStart + this.aiDisplay.length :
                    Math.min(this._iDisplayStart + this._iDisplayLength, this._iRecordsDisplay) : this._iDisplayEnd
            };
            ...
            this.oLanguage = {sProcessing: "Processing...", sLengthMenu: "Show _MENU_ entries", sZeroRecords: "No matching records found",
                sEmptyTable: "No data available in table", sInfo: "Showing _START_ to _END_ of _TOTAL_ entries", sInfoEmpty: "Showing 0 to 0 of 0 entries", sInfoFiltered: "(filtered from _MAX_ total entries)", sInfoPostFix: "", sSearch: "Search:", sUrl: "", oPaginate: {sFirst: "First", sPrevious: "Previous", sNext: "Next", sLast: "Last"}, fnInfoCallback: null};
            this.aoData = [];
            this.aiDisplay = [];
            ...
            this.fnServerData = function (a, b, c) {
                j.ajax({url: a, data: b, success: c, dataType: "json", cache: false, error: function () {
        ...
        function v(a, b, c) {
            ...
            if (typeof b.oPaginate != "undefined") {
                o(a.oLanguage.oPaginate, b.oPaginate,
                    "sFirst");
        ...
        function y(a, b) {
            a.aoColumns[a.aoColumns.length++] = {sType: null, _bAutoType: true, bVisible: true, bSearchable: true, bSortable: true, asSorting: ["asc", "desc"], sSortingClass: a.oClasses.sSortable, sSortingClassJUI: a.oClasses.sSortJUI, sTitle: b ?
                b.innerHTML : "", sName: "", sWidth: null, sWidthOrig: null, sClass: null, fnRender: null, bUseRendered: true, iDataSort: a.aoColumns.length - 1, sSortDataType: "std", nTh: b ? b : p.createElement("th"), nTf: null};
            ...
            if (typeof a.aoPreSearchCols[b] == "undefined" || a.aoPreSearchCols[b] === null)a.aoPreSearchCols[b] = {sSearch: "", bRegex: false, bSmart: true}; else {
                ...
                if (typeof a.aoPreSearchCols[b].bSmart == "undefined")a.aoPreSearchCols[b].bSmart =
                    true
            }
            D(a, b, null)
        }
        ...
        function D(a, b, c) {
            ...
            if (!b.bSortable || j.inArray("asc", b.asSorting) == -1 && j.inArray("desc",
                b.asSorting) == -1) {
        ...
        function w(a, b) {
            if (b.length != a.aoColumns.length && a.iDrawError != a.iDraw) {
                I(a, 0, "Added data (size " +
                    b.length + ") does not match known number of columns (" + a.aoColumns.length + ")");
            ...
            for (var d, f, e = 0; e < b.length; e++) {
                ...
                if (typeof a.aoColumns[e].fnRender == "function") {
                    ...
                    d.innerHTML = f;
                    if (a.aoColumns[e].bUseRendered)a.aoData[c]._aData[e] =
                        f
        ...
        function z(a) {
            ...
            if (a.nTHead.getElementsByTagName("th").length !== 0) {
                ...
                for (d = a.aoColumns.length; b < d; b++) {
                    ...
                    if (a.aoColumns[b].bVisible) {
                        if (a.aoColumns[b].sClass !== null)c.className =
        ...
        function C(a) {
            ...
            if (!(a.oFeatures.bServerSide && !pa(a))) {
                ...
                if (a.aiDisplay.length !== 0) {
                    ...
                    e.innerHTML = typeof a.oLanguage.sEmptyTable !=
                        "undefined" && a.fnRecordsTotal() === 0 ? a.oLanguage.sEmptyTable : a.oLanguage.sZeroRecords.replace("_MAX_", a.fnFormatNumber(a.fnRecordsTotal()));
                    d[f].appendChild(e)
                }
        ...
        function pa(a) {
            if (a.bAjaxDataGet) {
                ...
                c.push({name: "sColumns", value: ba(a)});
                ...
                if (a.oFeatures.bSort !== false) {
                    var f = a.aaSortingFixed !== null ? a.aaSortingFixed.length :
                        0, e = a.aaSorting.length;
        ...
        function qa(a, b) {
            ...
            if (!a.oScroll.bInfinite || a.oScroll.bInfinite && (a.bSorted || a.bFiltered))ca(a);
            a._iRecordsTotal = b.iTotalRecords;
            a._iRecordsDisplay = b.iTotalDisplayRecords;
            var c = ba(a);
            if (c = typeof b.sColumns != "undefined" && c !== "" && b.sColumns != c)var d = ra(a, b.sColumns);
        ...
        function oa(a) {
            ...
            for (var c = a.nTableWrapper, d = a.sDom.split(""), f, e, i, h, k, m, q, t = 0; t < d.length; t++) {
                ...
                if (i == "<") {
                    ...
                    c.appendChild(h);
                    c = h
                } else if (i == ">")c = c.parentNode; else if (i == "l" && a.oFeatures.bPaginate &&
            ...
            b.parentNode.replaceChild(a.nTableWrapper,
                b)
        }
        ...
        function va(a) {
            ...
            a.aoDrawCallback.push({fn: ya, sName: "scrolling"});
        ...
        function ya(a) {
            ...
            if (a.oScroll.sX === "") {
                ...
                if (j.browser.msie && j.browser.version <= 7)a.nTable.style.width =
                    u(j(a.nTable).outerWidth() - a.oScroll.iBarWidth)
            } else if (a.oScroll.sXInner !== "")a.nTable.style.width = u(a.oScroll.sXInner); else if (f == j(d).width() && j(d).height() < j(a.nTable).height()) {
            ...
            c.style.width = u(j(a.nTable).outerWidth());
            b.style.width = u(j(a.nTable).outerWidth() + a.oScroll.iBarWidth);
            if (a.nTFoot !== null) {
        ...
        function P(a, b, c) {
            za(a, b.sSearch, c, b.bRegex, b.bSmart);
            for (b =
                     0; b < a.aoPreSearchCols.length; b++)Aa(a, a.aoPreSearchCols[b].sSearch, b, a.aoPreSearchCols[b].bRegex, a.aoPreSearchCols[b].bSmart);
            n.afnFiltering.length !== 0 && Ba(a);
            a.bFiltered = true;
            a._iDisplayStart = 0;
            F(a);
            C(a);
        ...
        function Aa(a, b, c, d, f) {
            if (b !== "") {
                ...
                for (d = a.aiDisplay.length - 1; d >= 0; d--) {
                    f =
                        ha(a.aoData[a.aiDisplay[d]]._aData[c], a.aoColumns[c].sType);
                    if (!b.test(f)) {
        ...
        function Q(a, b) {
            ...
            for (var d = 0, f = b.length; d < f; d++) {
                a.asDataSearch[d] =
                    "";
                for (var e = 0, i = a.aoColumns.length; e < i; e++)if (a.aoColumns[e].bSearchable)a.asDataSearch[d] += ha(a.aoData[b[d]]._aData[e], a.aoColumns[e].sType) + "  ";
        ...
        function O(a, b) {
            var c = [], d = n.oSort, f = a.aoData, e, i, h, k;
        ...
        function W(a) {
            ...
            if (a.oFeatures.bSort && a.oFeatures.bSortClasses) {
                d = X(a);
                if (d.length >= i)for (b = 0; b < i; b++)if (d[b].className.indexOf(e +
                    "1") != -1) {
                    c = 0;
        ...
        function sa(a) {
            ...
            if (a.aLengthMenu.length == 2 && typeof a.aLengthMenu[0] == "object" && typeof a.aLengthMenu[1] == "object") {
                c = 0;
                for (d = a.aLengthMenu[0].length; c < d; c++)b += '<option value="' + a.aLengthMenu[0][c] + '">' + a.aLengthMenu[1][c] +
                    "</option>"
            } else {
                c = 0;
        ...
        function B(a) {
            for (var b =
                0; b < E.length; b++)if (E[b].nTable == a)return E[b];
            return null
        }
        ...
        function S(a) {
            for (var b = [], c = a.aoData.length, d = 0; d < c; d++)b.push(a.aoData[d].nTr);
            return b
        }
        ...
        function X(a) {
            ...
            for (i = b.length; e < i; e++) {
                ...
                h = d = 0;
                for (k = a.aoColumns.length; h < k; h++)if (a.aoColumns[h].bVisible)f.push(c[h -
                    d]); else {
        ...
        function ba(a) {
            for (var b = "", c = 0, d = a.aoColumns.length; c < d; c++)b +=
                a.aoColumns[c].sName + ",";
        ...
        function ka(a) {
            if (!(!a.oFeatures.bStateSave ||
                ...
                c += "],";
                c += '"aaSearchCols":[ ';
                for (b = 0; b < a.aoPreSearchCols.length; b++)c +=
                    '["' + encodeURIComponent(a.aoPreSearchCols[b].sSearch) + '",' + !a.aoPreSearchCols[b].bRegex + "],";
                c = c.substring(0, c.length - 1);
                c += "],";
                c += '"abVisCols":[ ';
        ...
        function Ia(a, b) {
            if (a.oFeatures.bStateSave) {
                var c, d = la(a.sCookiePrefix + a.sInstance);
                if (d !== null && d !== "") {
                    try {
                        c = typeof j.parseJSON == "function" ? j.parseJSON(d.replace(/'/g,
                            '"')) : eval("(" + d + ")")
                    } catch (f) {
                        return
                    }
        ...
        function Ha(a, b, c, d, f) {
            ...
            f = "";
            e = 9999999999999;
            if ((la(a) !== null ? p.cookie.length : b.length + p.cookie.length) + 10 > 4096) {
                a = p.cookie.split(";");
        ...
        function ea(a) {
            ...
            var b = [], c = [], d, f, e, i, h, k, m = function (G, Ma, ma) {
                for (; typeof G[Ma][ma] != "undefined";)ma++;
                return ma
            }, q = function (G) {
        ...
        this.fnUpdate = function (a, b, c, d, f) {
            var e = B(this[n.iApiIndex]), i = typeof b == "object" ? R(e, b) : b;
            if (typeof a != "object") {
                b = a;
                ...
                c = N(e, c);
                if (c !== null)e.aoData[i].nTr.getElementsByTagName("td")[c].innerHTML = b
            } else {
                ...
                for (var h = 0; h < a.length; h++) {
                    ...
                    if (e.aoColumns[h].fnRender !== null) {
                        b = e.aoColumns[h].fnRender({iDataRow: i, iDataColumn: h, aData: e.aoData[i]._aData, oSettings: e});
        ...
        this.fnSetColumnVis = function (a, b) {
            var c = B(this[n.iApiIndex]), d, f;
            f = c.aoColumns.length;
            var e, i;
            if (c.aoColumns[a].bVisible != b) {
                e = j(">tr", c.nTHead)[0];
                var h = j(">tr", c.nTFoot)[0], k = [], m = [];
                for (d = 0; d < f; d++) {
                    k.push(c.aoColumns[d].nTh);
                    m.push(c.aoColumns[d].nTf)
                }
                if (b) {
                    ...
                    if (b >= T(c)) {
                        ...
                        h && h.insertBefore(m[a], h.getElementsByTagName("th")[i]);
                        X(c);
                        d = 0;
                        for (f = c.aoData.length; d < f; d++) {
                            e = c.aoData[d]._anHidden[a];
        ...
        this.fnDestroy = function () {
            ...
            for (f = a.aoData.length; d <
                f; d++)c.appendChild(a.aoData[d].nTr);
        ...
        for (var na in n.oApi)if (na)this[na] = r(na);
        ...
        this.oApi._fnAjaxUpdate = pa;
        this.oApi._fnAjaxUpdateDraw = qa;
        this.oApi._fnAddOptionsHtml = oa;
        this.oApi._fnFeatureHtmlTable = va;
        this.oApi._fnScrollDraw = ya;
        this.oApi._fnAjustColumnSizing = V;
        this.oApi._fnFeatureHtmlFilter = ta;
        this.oApi._fnFilterComplete = P;
        this.oApi._fnFilterCustom = Ba;
        this.oApi._fnFilterColumn = Aa;
        this.oApi._fnFilter = za;
        this.oApi._fnBuildSearchArray = Q;
        this.oApi._fnFilterCreateSearch =
            ga;
        this.oApi._fnDataToSearch = ha;
        this.oApi._fnSort = O;
        this.oApi._fnSortAttachListener = aa;
        this.oApi._fnSortingClasses = W;
        this.oApi._fnFeatureHtmlPaginate = xa;
        this.oApi._fnPageChange = da;
        this.oApi._fnFeatureHtmlInfo = wa;
        this.oApi._fnUpdateInfo = Ca;
        this.oApi._fnFeatureHtmlLength = sa;
        this.oApi._fnFeatureHtmlProcessing = ua;
        ...
        this.oApi._fnCalculateColumnWidths = Z;
        this.oApi._fnScrollingWidthAdjust = Fa;
        ...
        this.oApi._fnEscapeRegex = ia;
        this.oApi._fnDeleteIndex = ja;
        this.oApi._fnReOrderIndex = ra;
        this.oApi._fnColumnOrdering = ba;
        this.oApi._fnLog = I;
        this.oApi._fnClearTable =
            ca;
        this.oApi._fnSaveState = ka;
        this.oApi._fnLoadState = Ia;
        this.oApi._fnCreateCookie = Ha;
        this.oApi._fnReadCookie = la;
        this.oApi._fnGetUniqueThs = ea;
        ...
        return this.each(function () {
            ...
            if (this.nodeName.toLowerCase() != "table")I(e, 0, "Attempted to initialise DataTables on a node which is not a table: " + this.nodeName); else {
                ...
                if (typeof g != "undefined" && g !== null) {
                    ...
                    e.oFeatures.bServerSide && e.oFeatures.bSort && e.oFeatures.bSortClasses && e.aoDrawCallback.push({fn: W, sName: "server_side_sort_classes"});
                    ...
                    if (typeof g.bStateSave !=
                        "undefined") {
                        e.oFeatures.bStateSave = g.bStateSave;
                        Ia(e, g);
                        e.aoDrawCallback.push({fn: ka, sName: "state_save"})
                    }
                ...
                if (c) {
                    ...
                    if (j(d[1]).hasClass(e.oClasses.sStripEven))e.asDestoryStrips[1] +=
                        e.oClasses.sStripEven;
