...
public class CommonAtlasProcesses {
    ...
    /**
     * Parses the response from Atlas REST API for the monitored process Returns true if process has been finished.
     *
     * @param response response received from Atlas REST API in HashMap format
    ...
    /**
     * Parses the response from Atlas REST API, by using parameters extracts Atlas job ID.
     *
     * @param response response received from Atlas REST API in HashMap format
