 ...
 */
@ServiceProvider
public class AE2ExperimentLoadingProcessCombinedWithAE1 extends AbstractLSFProcess {
    private final Collection<ConanParameter> parameters;
    private final MAGEMLAccessionParameter accessionParameter;

    private Logger log = LoggerFactory.getLogger(getClass());

    public AE2ExperimentLoadingProcessCombinedWithAE1() {
    ...
    public String getName() {
        return "experiment loading for AE2";
    }
