...
/**
 * Port of AE1 validation with insert process to Conan 2
 *
 * @author Natalja Kurbatova
 * @date 08-Nov-2010
 */
@ServiceProvider
public class AE1ValidationWithInsertProcess implements ConanProcess {

    private final Collection<ConanParameter> parameters;
    private final MAGEMLAccessionParameter accessionParameter;

    public AE1ValidationWithInsertProcess() {
    ...
    public boolean execute(Map<ConanParameter, String> parameters)
        ...
        if (accession.getAccession() == null) {
            ...
            //Check if ADFFromNDF exists
            File ADFFromNDF = new File(magemlFile.getParentFile(), magemlFile.getName()
                    .substring(0, magemlFile.getName().length() - 3) +
                    "adf.txt");
            ...
            if (!validator.validate(magemlFile) || !(ADFFromNDF.exists())) {
                // loader failed
                ProcessExecutionException pex = new ProcessExecutionException(1,
                                                                              "AE1 Validation with insert failed: " +
    ...
    public String getName() {
        return "AE1 Validate with insert";
    }
