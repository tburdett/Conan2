...
@ServiceProvider
public class ENASRAXMLToSampleTabLSFProcess extends AbstractBioSDLSFProcess {

	private Logger log = LoggerFactory.getLogger(getClass());


	public String getName() {
		return "topresampletabenasra";
	}
	...
	protected String getCommand(Map<ConanParameter, String> parameters)
		...
		File script = new File(scriptpath, "ENASRAXMLToSampleTab.sh");
