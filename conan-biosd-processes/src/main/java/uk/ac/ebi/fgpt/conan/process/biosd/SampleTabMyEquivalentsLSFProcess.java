...
@ServiceProvider
public class SampleTabMyEquivalentsLSFProcess extends AbstractBioSDLSFProcess {

	private Logger log = LoggerFactory.getLogger(getClass());

	public String getName() {
		return "sampletabmyequivalents";
	}
	...
	protected String getCommand(Map<ConanParameter, String> parameters)
		...
		File script = new File(scriptpath, "MyEquivalentsLoader.sh");
        ...
        File logfile = getDateTimeLogfile(outdir, "myequivalents");
