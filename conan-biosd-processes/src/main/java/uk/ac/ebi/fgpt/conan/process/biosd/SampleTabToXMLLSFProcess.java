...
@ServiceProvider
public class SampleTabToXMLLSFProcess extends AbstractBioSDLSFProcess {
	...
	protected String getCommand(Map<ConanParameter, String> parameters)
		...
		File script = new File(scriptpath, "SampleTabToGUIXML.sh");
        ...
        File xmlFile = new File(outdir, "gui.xml");
        File logfile = getDateTimeLogfile(outdir, "gui.xml");
